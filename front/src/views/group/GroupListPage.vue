...
const route = useRoute(); // useRoute 인스턴스
...
const activeGroupName = computed(() =>
    groupStore.getMyGroupList.find(g => g.id === activeGroupId.value)?.name || '내 그룹'
);
...
watch(activeGroupId, loadGroupData, { immediate: true }); // 컴포넌트 재사용 시 즉시 실행
...
/* Group 3980.png의 헤더와 유사하게 맞추기 위해 AppLayout 헤더 제외 */
